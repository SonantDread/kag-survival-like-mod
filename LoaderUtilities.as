// LoaderUtilities.as
// TODO: FIX THIS FILE, DO IN-DEPTH DEBUGGING
...
void onSetTile(CMap@ map, u32 index, TileType tile_new, TileType tile_old)
{
	...
	for(int i = 0; i < sectors.size(); i++){
		if(sectors[i].name == "SAND_BACKWALL"){
			map.SetTileSupport(index, -1); // TODO: fix this line of code: if blocks above this are placed, set them to -1 support aswell
