...
void AdjustCamera(CBlob@ this, bool is_in_render)
{
	...
	// } else {
	switch (zoomLevel) {
		case 0: zoom_target = 1.8f*.85f; zoomModifierLevel = 6*.85; break; // force max zoom
		case 1: zoom_target = 1.8f*.85f; zoomModifierLevel = 6*.85; break;
		case 2:	zoom_target = 1.8f*.85f; zoomModifierLevel = 6*.85; break;
	}
	// }
